<template>
	<header>
		...
		<ul class="navbar-nav">
			...
			<!-- ：to='a'可以绑定路径，实现动态更改路径 -->
			<!-- <li><router-link :to="a" class="nav-link">主页</router-link></li> -->
		...
		<ul class="navbar-nav ml-auto">
			<li><router-link :to="{name:'loginLink'}" class="nav-link" v-show="!isLogin">登陆</router-link></li>
			<li class="nav-link">
				{{currenUser}}
			</li>
...
<script>
	export default{
		computed:{
			...
			currenUser(){
				return this.$store.getters.currenUser;
			}
		}
	}
</script>
